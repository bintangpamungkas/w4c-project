            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    $facility=[
                        'id' => [
                            [
                                'title' => 'Pembuatan sistem pengelolaan sampah secara komprehensif pada lini distribusi',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Meningkatkan jumlah sampah yang dapat diolah lebih lanjut melalui cara daur ulang',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Pengolahan bertanggung jawab untuk sampah residu (sampah yang sulit didaur ulang) tanpa adanya pengiriman ke TPA (berdasar permintaan)',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                        ],
                        'en' => [
                            [
                                'title' => 'The making of comprehensive waste management system in the distribution line ',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Increase the number of waste that can be further processed through recycling method',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Responsible waste management for residual waste (waste that are difficult to be recycled) without sending it to the landfills (on demand)',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                        ],
