            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    $facility=[
                        'id' => [
                            [
                                'title' => 'Pilihan lokasi fleksibel di tempat-tempat umum mulai dari Sekolah, Kantor dan Fasilitas Publik lainnya',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Jumlah peserta maksimal hingga 30 orang dalam satu kali pertemuan',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Durasi kelas maksimal 120 menit dengan suasana yang menyennagkan sesuai target peserta',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                        ...
                        'en' => [
                            [
                                'title' => 'Choices of place are flexible, it can be in places ranging from schools, offices, or any other public spaces',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'The maximum duration of the class is 120 minutes with fun atmosphere that is adjusted to the target audience',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
