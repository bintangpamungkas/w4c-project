            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    $facility=[
                        'id' => [
                            [
                                'title' => 'Trainer berpengalaman dalam pembibitan & pengembangbiakan BSF',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Modul dan starter kit BSF',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Aula pelatihan',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Fasilitas pengolahan sampah organik dengan BSF',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Fasilitas pembibitan & pengembangbiakan BSF',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                        ],
                        'en' => [
                            [
                                'title' => 'Experienced trainers in terms of breeding and cultivating BSF',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'BSF Modules and Startet Kit',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                            ...
                            [
                                'title' => 'Organic waste processing facilities with BSF',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Breeding and cultivation facitilies of BSF',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                        ],
