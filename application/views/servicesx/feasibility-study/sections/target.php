<section class="g-bg-secondary <?= $this->agent->is_mobile() ? 'g-pt-50 g-pb-0' : 'g-pt-140 g-pb-100' ?>">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            $facility=[
                [
                    'title' => lang('hse_division'),
                    'icon' => 'icon-medical-031 u-line-icon-pro',
                    'color' => 'red',
                ],
                [
                    'title' => lang('sustainability_division'),
                    'icon' => 'icon-hotel-restaurant-132 u-line-icon-pro',
                    'color' => 'yellow',
                ],
                [
                    'title' => lang('csr_division'),
                    'icon' => 'icon-medical-022 u-line-icon-pro',
                    'color' => 'info',
                ],
                [
                    'title' => lang('government'),
                    'icon' => 'icon-real-estate-019 u-line-icon-pro',
                    'color' => 'orange',
                ],
                [
                    'title' => lang('consultant'),
                    'icon' => 'icon-education-009 u-line-icon-pro',
                    'color' => 'primary',
                ],
                [
                    'title' => lang('residential'),
                    'icon' => 'icon-real-estate-070 u-line-icon-pro',
                    'color' => 'purple',
                ],
                [
                    'title' => lang('office'),
                    'icon' => 'icon-hotel-restaurant-172 u-line-icon-pro',
                    'color' => 'brown',
                ],
                [
                    'title' => lang('residence'),
                    'icon' => 'icon-real-estate-070 u-line-icon-pro',
                    'color' => 'pink',
                ],
            ];
