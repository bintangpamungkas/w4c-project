                ...
                <div class="col-md-6">
                    ...
                    $welcome=[
                        'id' => [
                            ...
                            'subtitle' => 'Waste4Change memastikan tidak ada sampah yang tercampur saat diangkut menyediakan pengelolaan sampah secara optimal dengan sistem pengelolaan sampah bertanggung jawab',
                        ],
                        'en' => [
                            'small_title' => 'Daur Ulang Sampahmu Melalui',
                            'title' => lang($service_id),
                            'subtitle' => ' Waste4Change ensures that no waste will get mixed up during the collection process provide an optimal waste management with responsible waste management system ',
                        ],
                    ];
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="g-color-black-opacity-0_7 g-font-weight-300 <?= $this->agent->is_mobile() ? 'g-font-size-12' : 'g-font-size-16' ?> g-line-height-1_5 mb-3"><?= ucfirst($welcome['subtitle']) ?></h3>
                        </div>
                    </div>
