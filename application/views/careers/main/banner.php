...
<section>
	<div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall " data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
		<div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-black-opacity-0_6--after" style="height: 100%;background: url(<?= base_url(DIR_BG . 'career/Main-Banner1.jpg') ?>);background-size: cover;"></div>
		<div class="container">
			<div class="" style="padding-top: 84px;padding-bottom: 71px; height:80vh">
				<div class="g-pt-70" style="position: absolute; right: 0px;">
				...
				<div class="row align-items-center <?= $this->agent->is_mobile() ? 'float-left' : '' ?>" style="height:100%;<?= $this->agent->is_mobile() ? 'margin-top:-80px' : '' ?>">
					<div class="col-12">
