	...
	<?php else : ?>
		<div class="container">
			<div class="row justify-content-center my_tab_content">
				...
				<div class="col-md-6">
					<img class="g-mt-10" src="<?= get_image(DIR_BG . 'career/' . $copy->internship_program->image) ?>" alt="<?= $copy->internship_program->title ?>" style="width:100%; object-fit:cover;margin-left: auto; margin-right: auto;">
				</div>
			</div>
		</div>
		</div>
