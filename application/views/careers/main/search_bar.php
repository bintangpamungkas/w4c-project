...
<section class="g-bg-gray-light-v5" style="position: relative;">
	<div style="height: 10px;position: absolute;width: 80%;margin-top: -100px"></div>
				...
				<form action="<?= site_url('career/job') ?>" method="get">
					<div class="row align-items-end">
							...
							<div class="col">
								<div class="form-group g-m-reset" data-toggle="modal" data-target="#modal-mobile-search">
									<div class="input-group g-brd-primary--focus">
										...
										<input class="form-control g-pa-12 g-brd-left-none g-brd-none--focus" type="text" placeholder="<?= $copy->search_bar->Search . ' ' . $copy->search_bar->Position . ', ' . $copy->search_bar->Location . ', ' . $copy->search_bar->Type ?>">
									</div>
								</div>
								<style>
									.ui-autocomplete {
										...
										<div class="modal-content g-py-20">
											...
											<div id="modal-box">
												<div class="row g-mt-20 g-px-30">
													...
													<div class="col-12 g-pa-5">
														<div class="form-group g-ma-0">
															<input id="inputType" class="form-control g-pa-12 g-brd-none--focus" type="text" name="type" placeholder="<?= $copy->search_bar->Type ?>">
														</div>
													</div>
													<div class="col-12 g-pa-5">
													...
													<div class="col-12 g-pa-5">
														<a class="btn btn-outline-info btn-block g-pa-12 g-rounded-50 g-brd-2" href="<?= site_url('career/job') ?>"><?= strtoupper($copy->search_bar->ViewJobList) ?></a>
													</div>
												</div>
											</div>
										</div>
						...
						<?php else : ?>
							...
							<div class="col g-px-8">
								<div class="form-group g-ma-0">
									<input id="inputType" class="form-control g-pa-12 g-brd-none--focus" name="type" type="text" placeholder="<?= $copy->search_bar->Type ?>">
								</div>
							</div>
							<div class="col g-px-8">
