		...
		<div class="container">
			<div class="row content-middle-fullscreen with-header middle-center">
				<div class="col-md-12">
					...
					<div class="g-font-asap g-font-weight-900 g-letter-spacing-1_5 g-font-size-<?= $this->agent->is_mobile() ? '42 g-line-height-1' : '60 g-line-height-1' ?> mt-2 g-color-white" style="text-shadow: 0.5px 0.5px 0 #fff, -0.5px -0.5px 0 #fff, 0.5px -0.5px 0 #fff, -0.5px 0.5px 0 #fff, 3px 3px 5px #0000;"><?= get_lang('manage-your-waste') ?></div>
					<div class="g-font-asap g-font-weight-900 g-letter-spacing-1_5 g-font-size-<?= $this->agent->is_mobile() ? '42 g-line-height-1' : '60 g-line-height-1' ?> mt-2" style="color: #88C662;text-shadow: 0.5px 0.5px 0 #88C662, -0.5px -0.5px 0 #88C662, 0.5px -0.5px 0 #88C662, -0.5px 0.5px 0 #88C662, 3px 3px 5px #0000;"><?= get_lang('responsibly') ?></div>
...
<?php
	$this->load->view('sites/sections/subscriber');
?>
