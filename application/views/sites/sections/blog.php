<section class="g-bg-gray-light-v5 dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
    ...
    <div class="container <?= $this->agent->is_mobile() ? 'g-pt-75 g-pb-30' : 'g-pt-140 g-pb-70' ?>">
        ...
        $blog=[
            [
                'blog_title' => 'Waste4Change on Jakarta Fashion Week 2019 (October 20-26th, 2018) - a Less Waste Event',
                'blog_category' => 'EVENT & PROGRAM, WASTE MANAGEMENT, WASTE4CHANGE STORY',
                'blog_content' => 'Its safe to say that fashion and beauty are inseparable-both support each other in the long run....',
                'blog_author' => 'Amanda Bahraini',
                'blog_url' => 'https://waste4change.com/waste4change-on-jakarta-fashion-week-2019-october-20-26th-2018-a-less-waste-event/',
                'blog_date' => '12 Juni',
                'blog_image' => 'https://waste4change.com/wp-content/uploads/GARBAGE-BINS-2-Copy-580x390.png',
            ],
            [
                'blog_title' => '#4TipsBijakKelolaSampahW4C Competition (9-25 November 2018)',
                'blog_category' => 'EVENT & PROGRAM, WASTE MANAGEMENT, WASTE4CHANGE STORY',
                'blog_content' => 'In order to celebrate the 4th year of Waste4Change we invite all of you to raise the awareness about....',
                'blog_author' => 'Amanda Bahraini',
                'blog_url' => 'https://waste4change.com/4tipsbijakkelolasampahw4c-competition-9-25-november-2018/',
                'blog_date' => '07 Juli',
                'blog_image' => 'https://waste4change.com/wp-content/uploads/W4C-Kuis-01-Copy-Copy-580x368.jpg',
            ],
            [
                'blog_title' => 'Ellen MacArthur Foundation launches "The New Plastics Economy Global Movement"',
                'blog_category' => 'WASTE MANAGEMENT',
                'blog_content' => 'A Global Commitment to eradicate plastic waste and pollution at the source has been signed by 250 ...',
                'blog_author' => 'Amanda Bahraini',
                'blog_url' => 'https://waste4change.com/ellen-macarthur-foundation-launches-the-new-plastics-economy-global-movement/',
                'blog_date' => '03 Juli',
                'blog_image' => 'https://waste4change.com/wp-content/uploads/NPECGC_logo_Sand-580x390.jpg',
            ],
        ];
