<section id="blog" class="g-bg-gray-light-v5 dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden"
	...
	<div class="container <?= $this->agent->is_mobile() ? 'g-py-50' : 'g-py-70' ?>">
		...
		$blogs = [
			[
				'blog_title' => 'Waste4Change Launches Community Development (Comdev) Service to Support CSR Program in Waste Management',
				'blog_category' => 'WASTE MANAGEMENT',
				'blog_content' => 'Corporate Social Responsibility Corporate Social Responsibility (CSR) is a scheme to make companies more accountable, be it for the company itself, stakeholders, and also for society....',
				'blog_author' => 'MIRIAM BAHAGIJO',
				'blog_url' => 'https://waste4change.com/waste4change-launches-community-development-comdev-service-to-support-csr-program-in-waste-management/',
				'blog_date' => '02/03/2020',
				'blog_image' => 'https://waste4change.com/wp-content/uploads/IMG_8066-580x390.jpg',
			],
			[
				'blog_title' => 'PT DOW Indonesia and Waste4Change Launch Bogor TPS 3R Optimization Program in 2020',
				'blog_category' => 'WASTE MANAGEMENT',
				'blog_content' => 'Friday, January 24th, 2020 – PT DOW Indonesia and Waste4Change launched and inaugurated the Optimization Program of Reduce, Reuse and Recycle Waste Management Site (Tempat...',
				'blog_author' => 'MIRIAM BAHAGIJO',
				'blog_url' => 'https://waste4change.com/pt-dow-indonesia-and-waste4change-launch-bogor-tps-3r-optimization-program-in-2020/',
				'blog_date' => '01/31/2020',
				'blog_image' => 'https://waste4change.com/wp-content/uploads/IMG_9494-580x390.jpg',
			],
			[
				'blog_title' => 'Things You Need to Know About the Green Economy',
				'blog_category' => 'WASTE MANAGEMENT',
				'blog_content' => 'What is Green Economy and Why?  There was a general consensus that the economic system we are using now is no longer suitable due to...',
				'blog_author' => 'MIRIAM BAHAGIJO',
				'blog_url' => 'https://waste4change.com/things-you-need-to-know-about-the-green-economy/',
				'blog_date' => '01/25/2020',
				'blog_image' => 'https://waste4change.com/wp-content/uploads/5-Principles-Together-580x390.png',
			],
		];
