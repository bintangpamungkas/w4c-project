    ...
    <div class="container">
        ...
        if($brand_id=='cocacola'){
            ...
            $en=[
                ...
                'content_2_content' => 'Designing product by using materials from responsible source, all our paperboard is sourced from Forest Stewardship Council® (FSC®) certified forests and other controlled sources',
            ];
            ...
            <div class="row no-gutters">
                ...
                <div class="<?= $this->agent->is_mobile() ? 'g-mt-100' : '' ?> text-center">
                    <header id="story_title_desktop" class="text-uppercase g-mb-35">
                        ...
                        <div class="g-width-70 g-brd-bottom g-brd-2 g-brd-blue d-none"></div>
                    </header>
                    ...
                    <a target="_blank" class="btn btn-info g-color-white g-font-size-13 g-rounded-50 g-pl-20 g-pr-15 g-py-9 g-mb-30" href="http://www.tetrapak.com/id/sustainability/daur-ulang-kemasan">
