...
<div id="container">
	...
	<a class="btn btn-info g-color-white g-brd-2 text-uppercase g-rounded-50 g-px-30 g-py-9 g-ma-10" href="#" onclick="window.history.back()"><?= lang('back_to_previous_page') ?></a>
