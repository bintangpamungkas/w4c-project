...
<div class="content">
    ...
    if($activity=='register'){
        ...
        <div class="text-center">
            ...
            <br>
            <br>
            <?= APPNAME ?> membantu membuat sampahmu jadi lebih bernilai dan bermanfaat. Kamu dapat menjual sampahmu untuk membeli berbagai macam e-voucher seperti pulsa, token listrik hingga topup saldo go-pay.
        </div>
        <div class="text-center">
        ...
        <div class="text-center">
            ...
            <br>
            <br>
            Tim Kami akan segera menghubungimu untuk melakukan verifikasi lebih lanjut mengenai pengajuan Kamu untuk menjadi agen <?= APPNAME ?>
        </div>
        <div class="text-center">
            <div class="image-icon">
                <img src="<?= base_url('assets/img/sampahmuda/welcome.png') ?>">
        ...
        <div class="text-center">
            Kamu mendapatkan email ini karena ada perubahan informasi akun Kamu di <?= APPNAME ?>
            <br>
            <br>
