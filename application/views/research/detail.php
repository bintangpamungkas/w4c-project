<?php foreach ($researchs as $research) : ?>
    <?php if ($research['slug'] == $slug) : ?>
        ...
        <div class="row g-bg-lightblue g-py-40 g-mt-10 text-center rounded justify-content-center">
            <div class="col-md-5 <?= $this->agent->is_mobile() ? 'g-mb-10' : '' ?>">
                ...
                <a href="<?= $research['file']['links']['download']['en'] ?>" class="btn btn-md  u-btn-outline-blue u-btn-hover-v1-4 g-rounded-50 g-mr-10 g-mb-15 g-mt-5 w-100">
                    Download <i class="g-ml-10 icon-cloud-download"></i>
                </a>
            </div>

            <div class="col-md-5 <?= $this->agent->is_mobile() ? 'g-mt-10' : '' ?>">
                ...
                <a href="<?= $research['file']['links']['download']['id'] ?>" class="btn btn-md  u-btn-outline-blue u-btn-hover-v1-4 g-rounded-50 g-mr-10 g-mb-15 g-mt-5 w-100">
                    Download <i class="g-ml-10 icon-cloud-download"></i>
                </a>
            </div>
        </div>
