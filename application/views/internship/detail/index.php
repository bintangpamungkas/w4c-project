...
<?php
$this->load->view('internship/detail/search_bar');
$this->load->view('internship/detail/description');
$this->load->view('internship/detail/related_job');
$this->load->view('internship/detail/js');
