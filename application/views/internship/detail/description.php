    ...
    <div class="row">
      <div class="col">
        ...
        <?php if ($this->agent->is_mobile()) : ?>
          <div class="g-flex-centered g-bg-img-hero u-bg-overlay w4c-bg-blue-opacity-0_5--after g-py-20 g-mb-25" style="background-image: url(<?= get_image(DIR_BG . 'internship/' . $job_category->{$job->category}->image) ?>); height:161px; width:100%;object-fit:cover">
      ...
      <!-- End Detail Section -->
      <?php $this->load->view('internship/detail/share') ?>
      <?php if ($this->agent->is_mobile()) : ?>

        <div class="col-12">
          <a class="btn btn-info btn-block g-font-size-18 g-font-weight-600 g-color-white--active g-py-12 g-mt-50 g-rounded-50 text-uppercase" href="https://docs.google.com/forms/d/e/1FAIpQLSc71hhnrWLhPSZgFGJ2ZSmg28k8PMIrRNZZnjllD8q6IzUxew/viewform"><?= $copy->ApplyNow ?></a>
        </div>
      <?php endif; ?>
    </div>
