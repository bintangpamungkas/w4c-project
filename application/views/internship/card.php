            ...
            <div class="col-md-6 mt-2">
                <div class="card mx-auto " style="width: <?= $this->agent->is_mobile() ? '100%' : '70%' ?>;height: 450px;box-shadow: 0 .125rem .25rem rgba(0,0,0,.075)!important;">
                    ...
                    <div class="card-body ml-2">
                        ...
                        <a href="#" class="btn btn-default g-color-white g-brd-2 g-brd-white-opacity-0_2 g-font-size-12 text-uppercase  g-rounded-50 g-width-190 g-height-35" style="background-color:#898989;z-index: 5;margin-top:-750px;font-weight: 700;margin-left:<?= $this->agent->is_mobile() ? '140px' : '170px' ?>"><?= $copy->card_batch2->button ?></a>
                    </div>
                </div>
            </div>
                ...
                <div class="card mx-auto " style="width: <?= $this->agent->is_mobile() ? '100%' : '70%' ?>;height:450px;box-shadow: 0 .125rem .25rem rgba(0,0,0,.075)!important;">
                    ...
                    <div class="card-body ml-2">
                        ...
                        <div class="remind-me text-<?= $this->agent->is_mobile() ? 'center' : 'left' ?>">
                            <a href="https://docs.google.com/forms/d/e/1FAIpQLScxaQ4EkQ0pYM5uDc_8OcM27zRHymUKzrDODAD6jChIwPJ7AA/viewform" class="btn btn-info g-color-white g-brd-2 g-brd-white-opacity-0_2 g-font-size-15 g-rounded-50 g-width-200 g-height-40"><?= $copy->card_batch1->button ?></a>
                        </div>
                    </div>
                </div>
            </div>
