...
$about=[
    'id' => [
        ...
        'subtitle' => lang($service_id).' adalah penerapan sistem kelola sampah yang menerapkan pemilahan sampah di sumber dan memastikan pengolahan sampah lebih optimal, dan adanya pelaporan alur sampah.',
    ],
    'en' => [
        'title' => 'no more mixed waste',
        'subtitle' => lang($service_id).' is the application of a waste management system which implements waste segregation from the source and ensures a more optimal waste management, along with a report on the waste flow ',
    ],
];
    ...
    <div class="container <?= $this->agent->is_mobile() ? 'g-pt-50 g-pb-10' : 'g-pt-80 g-pb-80' ?>">
        <div class="row">
            ...
            <div class="col-lg-6 g-mb-30 <?= $this->agent->is_mobile() ? 'd-none' : '' ?>">
                <div style="background: url('<?= base_url('assets/img/bg/W4C_RPM_area_pemilahan_2x.jpg') ?>');height: 400px;background-size: cover"></div>
            </div>
