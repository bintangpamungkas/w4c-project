	<section class="g-bg-secondary">
		...
		<div class="container <?= $this->agent->is_mobile() ? 'g-pt-80 g-pb-50' : 'g-py-70' ?>">
			<div class="text-center g-mb-50">
				<h2
					class="g-font-asap g-color-black-dark-v2 g-font-weight-600 text-uppercase <?= $this->agent->is_mobile() ? 'g-font-size-20' : '' ?>"><?=$section->section_title?></h2>
				...
				<div class="">
					<div id="project-highlight-carousel" class="owl-theme row justify-content-md-center"
						...
						<?php
							...
							foreach ($section->project_items as $project) :
