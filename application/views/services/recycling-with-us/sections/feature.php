        ...
        <div class="row">
            ...
            $solution=[
                'id' => [
                    ...
                    [
                        'name' => 'Pengumpulan',
                        'description' => 'Memberikan fasilitas dan mendorong upaya penarikan kembali kemasan bekas dari brand',
                ...
                'en' => [
                    [
                        'name' => 'Education',
                        'description' => 'Providing information on the importance of responsible brand used packaging management',
                        'icon' => 'icon-media-072 u-line-icon-pro',
                        'number' => 1,
                    ],
                    [
                        'name' => 'Collection',
                        'description' => 'Provide facilities and encourage efforts to reclaim used packaging from the brand',
                        'icon' => 'icon-transport-094 u-line-icon-pro',
                        'number' => 2,
                    ],
                    [
                        'name' => 'Management',
                        'description' => 'Ensure that all brand used packaging waste can be processed and recycled',
                        'icon' => 'icon-real-estate-024 u-line-icon-pro',
                        'number' => 3,
                    ],
                    [
                        'name' => 'Reporting',
                        'description' => 'We release the report of waste flow comprehensively starting from upstream to downstream',
                        'icon' => 'icon-finance-119 u-line-icon-pro',
                        'number' => 4,
                    ],
                ]
