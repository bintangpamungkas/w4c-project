                ...
                <div class="col-md-6">
                    ...
                    $welcome=[
                        'id' => [
                            ...
                            'subtitle' => 'Optimalkan pemilahan dan pengolahan sampah anorganik Anda untuk dapat didaur ulang secara maksimal',
                        ],
                        'en' => [
                            'small_title' => 'Daur Ulang Sampahmu Melalui',
                            'title' => lang($service_id),
                            'subtitle' => 'Optimized your inorganic waste segregation and management in order for them to be recyled',
                        ],
                    ];
