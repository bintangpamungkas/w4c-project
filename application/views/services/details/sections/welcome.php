...
<section>
	<div id="<?= $section_slug ?>" class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall "
		...
		<div class="full-height-block pending-show animated d-zap"
		     style="background-image: <?= $this->agent->is_mobile() ? 'linear-gradient(180deg, rgba(255, 255, 255, 0.5) 20%, rgba(255, 255, 255, 0.6) 40%, rgba(255, 255, 255, 0.3) 100%)' : 'linear-gradient( 100deg , rgb(256, 256, 256) 40%, rgba(256, 256, 256, 0.85) 70%, rgba(256, 256, 256,0) 100%);' ?>">
			<div class="container">
