									...
									if (!empty($porto->portfolio_url)) {
										...
										<div class="col-12">
											<div class="no-gutters g-line-height-1_3 g-mt-20">
												<a class="btn btn-outline-info g-font-weight-700 text-uppercase g-rounded-25 g-brd-none g-brd-blue--hover" href="<?= get_url($porto->portfolio_url) ?>"><?= get_lang('view-project') ?> <i
