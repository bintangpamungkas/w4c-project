					...
					<div class="col-<?= $this->agent->is_mobile() ? '12' : '6' ?>">
						<div class="row no-gutters g-bg-white u-shadow-v20 g-mx-10">
							<?php if ($this->agent->is_mobile()): ?>
								<div class="col-12">
									<img class="img-fluid mx-auto" src="<?= get_image(DIR_SERVICE . $service_id . '/portfolio/p-' . $porto->portfolio_image) ?>" alt="<?= 'thumbnail' . $porto->portfolio_client ?>"
							...
							<div class="col-<?= $this->agent->is_mobile() ? '12' : '6' ?> g-pa-30 ">
								<div class="row no-gutters">
									<div class="col-12 <?= $index ?> align-height-item">
										<img class="g-mb-15" src="<?= get_image(DIR_SERVICE . $service_id . '/portfolio/' . $porto->portfolio_client_logo) ?>" alt="<?= $porto->portfolio_client ?>"
									...
									if (!empty($porto->portfolio_url)) {
										...
										<div class="col-12">
											<div class="no-gutters g-line-height-1_3 g-mt-20">
												<a class="btn btn-outline-info g-font-weight-700 text-uppercase g-rounded-50 g-brd-white g-brd-none--hover g-bg-white--hover g-color-white g-color-blue--hover g-mt-20" href="<?= get_url($porto->portfolio_url) ?>"><?= get_lang('view-project') ?> <i
							...
							<?php if (!$this->agent->is_mobile()): ?>
								<div class="col-6">
									<img class="img-fluid mx-auto" src="<?= get_image(DIR_SERVICE . $service_id . '/portfolio/l-' . $porto->portfolio_image) ?>" alt="<?= 'thumbnail' . $porto->portfolio_client ?>"
