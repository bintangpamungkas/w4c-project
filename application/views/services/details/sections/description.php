      ...
      if($this->agent->is_mobile()){
        ...
        <div class="col-lg-6 g-mb-30>">
          <div class="mb-2 text-center">
            <span class="g-color-gray-dark-v3 g-font-weight-700 g-font-size-16 text-uppercase"><?= lang('description') ?></span>
        ...
        <div class="col-md-6">
          <div class="g-mb-5--lg g-px-20" style="margin-top:-30px">
            <p class="g-pa-20 g-color-white" style="background: linear-gradient(90deg, rgba(11, 144, 185, 0.9), rgba(19, 182, 127, 0.9));<?= $this->agent->is_mobile() ? '' : 'margin-left: -100px' ?>">
              <?= empty($service->service_description) ? lang('long_lorem') : $service->service_description ?>
            </p>
          </div>
