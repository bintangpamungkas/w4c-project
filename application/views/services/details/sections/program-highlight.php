	...
	<section class="g-bg-secondary">
		...
		<div class="container <?= $this->agent->is_mobile() ? 'g-pt-80 g-pb-50' : 'g-py-70' ?>">
			<div class="text-center g-mb-50">
				<?php $short_name=explode('(',$service->service_name)?>
				<h2 class="g-font-asap g-color-black-dark-v2 g-font-weight-600 text-uppercase <?= $this->agent->is_mobile() ? 'g-font-size-20' : '' ?>"><?=$section_name?> <?=$short_name[0]?></h2>
									...
									<div class="" style="max-height:200px">
										<div class="d-block u-bg-overlay g-bg-green-gradient-opacity-v2--after g-mb-30 g-mb-0--md">
											...
											<div class="u-bg-overlay__inner <?= $this->agent->is_mobile() ? 'g-font-size-14' : 'g-font-size-18' ?> g-font-weight-700 g-color-white g-line-height-1_2 g-pos-abs g-left-20 g-top-30 g-pr-50 text-uppercase ">
												...
												<a class="btn btn-outline-info <?= $this->agent->is_mobile() ? 'btn-xs' : '' ?> g-rounded-50 g-brd-white g-color-white g-mt-20 g-brd-blue--hover" href="<?= site_url('project/' . $project->service_slug) ?>"><?= get_lang('view-project') ?> <i class="fa fa-angle-right g-ml-10"></i></a>
											</div>
										</div>
									</div>
								</div>
