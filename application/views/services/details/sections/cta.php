	...
	<div style="background:rgba(248,248,248,0.78)">
		<div class="container g-pt-100 g-pb-50">
			<div class="text-center g-mb-50">
				<h4 class="g-font-asap g-color-black g-font-weight-500 <?= $this->agent->is_mobile() ? 'g-font-size-18' : '' ?>"><?= $service->service_id == 32 ? '' : get_lang('start_your') ?>
					...
					<?= $service->service_id == 33 ? get_lang('in-your-house') : '' ?> <?= $service->service_id == 34 ? get_lang('now') : get_lang('now!') ?></h4>
