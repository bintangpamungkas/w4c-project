	...
	<section class="g-bg-secondary">
		...
		<div class="container <?= $this->agent->is_mobile() ? 'g-pt-50 g-pb-10' : 'g-pt-80 g-pb-80' ?>">
			<div class="text-center g-mb-50">
				<h2 class="g-font-asap g-color-black g-font-weight-600 text-uppercase <?= $this->agent->is_mobile() ? 'g-font-size-25' : '' ?>"><?= get_lang('we-offer') . ' ' . count($offers) . ' ' . get_lang('programs') ?></h2>
