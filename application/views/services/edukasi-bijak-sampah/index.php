<!-- Hotjar Tracking Code for https://waste4change.com/official/service/edukasi-bijak-sampah -->
<script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:1380875,hjsv:6};
                ...
                <div class="col-md-6 col-10">
                    ...
                    $welcome=[
                        'id' => [
                            ...
                            'subtitle' => 'Dapatkan pemahaman dan informasi lengkap mengenai pengelolaan sampah yang lebih baik dan bertanggung jawab langsung di tempat Anda',
                        ],
                        'en' => [
                            'small_title' => 'Daur Ulang Sampahmu Melalui',
                            'title' => lang($service_id),
                            'subtitle' => 'Get a comprehensive understanding about a better and more responsible waste management system directly in Your place',
                        ],
                    ];
                    $welcome=$this->session->userdata('language')=='en' ? $welcome['en'] : $welcome['id'];
                    ?>
                    <h3 class="g-color-black-opacity-0_8 g-font-weight-700 <?= $this->agent->is_mobile() ? 'g-font-size-30' : 'g-font-size-50' ?> mb-4 g-font-asap" style="line-height: 1.2"><?= $welcome['title'] ?> (EDUBIS)</h3>
                    <div class="row">
                        <div class="col-md-12">
