            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    $facility=[
                        'id' => [
                            [
                                'title' => 'Tersedia untuk wilayah Bekasi dan sekitarnya',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Frekuensi pengangkutan sampah seminggu sekali',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Pengangkutan khusus sampah anorganik',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Pemberian kantong sampah berwarna untuk membantu proses pemilahan',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                        ...
                        'en' => [
                            ...
                            [
                                'title' => 'The waste collection frequency is once a week',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Waste collection specifically for inorganic waste',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
                                'title' => 'Distribution of colored waste bin to help with the segregating process',
                                'icon' => 'fa fa-check',
                                'color' => 'info',
                            ],
                            [
