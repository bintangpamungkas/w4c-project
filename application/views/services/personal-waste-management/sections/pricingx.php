<section class="<?= $this->agent->is_mobile() ? 'g-pt-50 g-pb-0' : 'g-pt-100 g-pb-100' ?>">
    ...
    <div class="container">
        ...
        <div class="row no-gutters align-items-center justify-content-center">
            ...
            <h3 class="col-md-12 text-center g-mb-30 d-none">
            ...
            <div class="col-md-4 g-mb-30">
                ...
                <article class="text-center g-brd-around g-color-gray g-brd-gray-light-v5 g-pa-10">
                    <div class="g-bg-gray-light-v5 g-pa-30">
                        <!-- Article Title -->
                        <h4 class="text-uppercase g-color-gray-dark-v3 g-font-weight-500 g-mb-10">PROMO</h4>
                        <!-- End Article Title -->
                        <em class="g-font-style-normal">1 Bulan</em>

                        <hr class="g-brd-gray-light-v4 g-my-10">

                        <div class="g-color-info g-my-20">
                            <strike class="text-muted">175.000</strike>
                            <strong class="d-block g-font-size-30 g-line-height-1_2">125.000</strong>
                        </div>
            ...
            <div class="col-md-4 g-mb-30">
                ...
                <article class="text-center g-brd-around g-color-gray g-brd-gray-light-v5 g-pa-10">
                    <div class="g-bg-gray-light-v5 g-pa-30">
                        ...
                        <div class="g-color-info g-my-20">
                            <strike class="text-muted">1.050.000</strike>
                            <strong class="d-block g-font-size-30 g-line-height-1_2">750.000</strong>
                        </div>
            ...
            <div class="col-md-4 g-mb-30">
                ...
                <article class="text-center g-brd-around g-color-gray g-brd-gray-light-v5 g-pa-10">
                    <div class="g-bg-gray-light-v5 g-pa-30">
                        ...
                        <div class="g-color-info g-my-20">
                            <strike class="text-muted">2.100.000</strike> + Diskon 15%
                            <strong class="d-block g-font-size-30 g-line-height-1_2">1.275.000</strong>
                        </div>
