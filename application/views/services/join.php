	...
	<div class="row justify-content-center">
		<div class="col-md-8">
            ...
            $(window).ready(function () {
				...
				<iframe id="<?= $this->agent->is_mobile() ? 'gform' : '' ?>" style="height: <?= $this->agent->is_mobile() ? '1100px' : '1200px' ?>;width: 100%;border: none" src="<?=$service->service_proposal_url?>?embedded=true">Memuat...</iframe>
			</div>
		</div>
	</div>
</div>
