				...
				?>
						<div class="row justify-content-center">
							<div class="col-md-11 col-12">
								<div id="waste-facility-carousel" class="col-md-12 owl-theme" style="margin: 0 0 30px 0!important;">
									<?php
										$i = 0;
										foreach ($facilities as $facility) :
											...
											<div class="g-color-black g-bg-white--hover text-center g-rounded-10 g-transition-0_3 g-px-40 g-py-10">
												<div class="g-mx-auto g-mx-30" style="">
													<img class="img-fluid u-block-hover__main--zoom-v1 mb-3" src="<?= get_image(DIR_ICON . 'flow/' . $facility->facility_icon) ?>" alt="facility icon" style="width: 100%">
												</div>
												<div class="g-pa-15">
						...
						<script>
							$(window).ready(function () {
								var element_id = '#waste-facility-carousel';
								...
								<div class="<?=$service->service_id==33 ? 'col-md-3' : 'col-md-4'?>">
									<article class="g-transition-0_3">
										<div class="g-color-black g-bg-white--hover text-center g-rounded-10 g-transition-0_3 g-px-20 g-py-10" style="padding: 30px 0 0 0!important;">
											<img class="img-fluid u-block-hover__main--zoom-v1 mb-3" src="<?= base_url(DIR_ICON . 'flow/' . $facility->facility_icon) ?>" alt="Image Description" style="width: 40%">
											<div class="g-pa-15">
