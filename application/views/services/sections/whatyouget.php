		...
		<section class="g-bg-white <?= $this->agent->is_mobile() ? 'g-pt-80 g-pb-50' : 'g-py-70' ?>">
			<div class="container">
				<div class="text-center g-mb-50">
					...
					<div
						class="mt-2 mb-4"> <?= (count($flow_category) == 1 && !empty($rdf)) ? ($rdf == 'rdf' ? get_lang('residual-waste-treatment-using-rdf-technology') : get_lang('residual-waste-treatment-at-the-landfill')) : '' ?></div>
