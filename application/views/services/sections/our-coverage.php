			...
			<?php elseif ($service_id == 'akabis-waste-management-academy'): ?>
				<div class="row justify-content-between">
					<div class="col-md-auto g-mb-10">
						<img src="<?= base_url() . DIR_ICON ?>pin/google-blue.png" alt="blue pin" style="height:30px; margin-right:10px; margin-bottom:0">
						<?= get_lang('track-record') . ' AKABIS CLASS' ?>
						<br>
						<span style="display:inline-block; width: 20px;height: 20px; background-color: #7ab74e40; border: 2px solid #7ab74ebb; margin: 10px 16px -5px 5px"></span>
						<?= get_lang('our-coverage') . ' AKABIS CLASS' ?>
					</div>
					<div class="col-md-auto g-mb-10 ">
						<img src="<?= base_url() . DIR_ICON ?>pin/google-green.png" alt="green pin" style="height:30px; margin-right:10px; margin-bottom:0">
						<?= get_lang('track-record') . ' AKABIS EXPERIENCE' ?>
						<br>
						<span style="display:inline-block; width: 20px;height: 20px; background-color: #17a2b840; border: 2px solid #17a2b8bb;margin: 10px 16px -5px 5px"></span>
