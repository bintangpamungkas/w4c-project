		...
		$pricings = [
			'id' => [
				...
				[
					'price_title' => 'PAKET<br>12 BULAN',
					'price_subtitle' => 'Anda akan berlangganan selama 12 bulan',
					'price_discount' => 'Rp2.400.000',
					'price_new' => 'Rp1.035.000',
					'price_tax' => 'Termasuk PPN',
					'is_highlight' => 0,
					'price_discount_message' => 'Lebih Hemat',
					'price_discount_nominal' => 'Rp900.000',
					'week' => 2,
				],
				[
					'price_title' => 'PAKET<br>6 BULAN',
					'price_subtitle' => 'Anda akan berlangganan selama 6 bulan',
					'price_discount' => 'Rp1.200.000',
					'price_new' => 'Rp555.000',
					'price_tax' => 'Termasuk PPN',
					'is_highlight' => 0,
					'week' => 2,
	...
	if ($this->agent->is_mobile()) :
		...
		<div class="container">
			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="col-md-12 mb-4 text-center" style="font-size: 18px; line-height: 29px;color: #52575C;">Pilih berdasarkan intensitas pengangkutan dan jangka waktu</div>
				<style>
					.btn-secondary-2 {
						background: #F0F0F0;
						border-color: #F0F0F0;
				...
				<div class="col-12 text-center">
					<a class="btn btn-info g-color-white g-font-size-13 g-px-30 g-py-9 g-mb-10" href="javascript:void(0);" data-pricing-week-mobile-btn="1" onclick="openPricingWeek(1, 2);">
						1 MINGGU SEKALI
					</a>
					<a class="btn btn-secondary-2 g-font-size-13 g-px-30 g-py-9 g-mb-10" href="javascript:void(0);" data-pricing-week-mobile-btn="2" onclick="openPricingWeek(2, 1);">
						2 MINGGU SEKALI
					</a>
				</div>
				<div class="col-md-12 mt-2 mb-4 text-center" data-pricing-week-mobile="1" style="color: rgba(0, 0, 0, 0.5);">Pengangkutan akan dilakukan setiap <strong>1 minggu</strong> sekali</div>
				<div class="col-md-12 mt-2 mb-4 text-center" data-pricing-week-mobile="2" style="color: rgba(0, 0, 0, 0.5);display:none;">Pengangkutan akan dilakukan setiap <strong>2 minggu</strong> sekali</div>
				...
				<div id="testi-carousel" class="owl-theme" data-pricing-week-mobile="1">
					<?php
						foreach ($pricing_content as $pricing) :
							if($pricing['week'] == 2) continue;
							?>
				...
				<div id="testi-carousel-2" class="owl-theme" data-pricing-week-mobile="2">
					<?php
						foreach ($pricing_content as $pricing) :
							if($pricing['week'] == 1) continue;
							?>
						<article class="box text-center g-bg-white g-rounded-15 g-overflow-hidden g-transform-scale-1_05--hover g-transition-0_3">
				...
				<script>
					function openPricingWeek(valueOpen, valueHide) {
						$(`[data-pricing-week-mobile='${valueOpen}'`).show();
						$(`[data-pricing-week-mobile='${valueHide}'`).hide();
						
						$(`[data-pricing-week-mobile-btn='${valueOpen}'`).removeClass('btn-secondary-2');
						$(`[data-pricing-week-mobile-btn='${valueOpen}'`).addClass('btn-info');
						$(`[data-pricing-week-mobile-btn='${valueOpen}'`).addClass('g-color-white');
						$(`[data-pricing-week-mobile-btn='${valueHide}'`).removeClass('btn-info');
						$(`[data-pricing-week-mobile-btn='${valueHide}'`).addClass('btn-secondary-2');
						$(`[data-pricing-week-mobile-btn='${valueHide}'`).removeClass('g-color-white');
					}
				</script>

				<script>
					$(document).ready(function() {
						var element_ids = ['#testi-carousel', '#testi-carousel-2'];
						element_ids.forEach(element_id => {
							...
							if(element_id == '#testi-carousel-2') $('#testi-carousel-2').hide();
						});
					});
				</script>
	...
	<?php else : ?>
		...
		<div class="container">
			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="col-12 text-center">
					<a class="btn btn-info g-color-white g-font-size-13 g-px-30 g-py-9 g-mb-10" href="javascript:void(0);" data-pricing-week-desktop-btn="1" onclick="openPricingWeek(1, 2);">
						1 MINGGU SEKALI
					</a>
					<a class="btn btn-secondary-2 g-font-size-13 g-px-30 g-py-9 g-mb-10" href="javascript:void(0);" data-pricing-week-desktop-btn="2" onclick="openPricingWeek(2, 1);">
						2 MINGGU SEKALI
					</a>
				</div>
				<div class="col-md-12 mt-2 mb-4 text-center" data-pricing-week-desktop="1" style="color: rgba(0, 0, 0, 0.5);">Pengangkutan akan dilakukan setiap <strong>1 minggu</strong> sekali</div>
				<div class="col-md-12 mt-2 mb-4 text-center" data-pricing-week-desktop="2" style="color: rgba(0, 0, 0, 0.5);display:none;">Pengangkutan akan dilakukan setiap <strong>2 minggu</strong> sekali</div>
				...
				<?php
					foreach ($pricing_content as $pricing) :
						?>
					<div class="col-md-4 g-pt-100 g-mb-30 g-px-20" style="<?= ($pricing['week'] == 2 ? 'display:none;' : '') ?>" data-pricing-week-desktop="<?= $pricing['week'] ?>">
						<!-- Article -->
				...
				<script>
					function openPricingWeek(valueOpen, valueHide) {
						$(`[data-pricing-week-desktop='${valueOpen}'`).show();
						$(`[data-pricing-week-desktop='${valueHide}'`).hide();
						
						$(`[data-pricing-week-desktop-btn='${valueOpen}'`).removeClass('btn-secondary-2');
						$(`[data-pricing-week-desktop-btn='${valueOpen}'`).addClass('btn-info');
						$(`[data-pricing-week-desktop-btn='${valueOpen}'`).addClass('g-color-white');
						$(`[data-pricing-week-desktop-btn='${valueHide}'`).removeClass('btn-info');
						$(`[data-pricing-week-desktop-btn='${valueHide}'`).addClass('btn-secondary-2');
						$(`[data-pricing-week-desktop-btn='${valueHide}'`).removeClass('g-color-white');
					}
				</script>
			</div>
