        ...
        <div class="row justify-content-center g-ma-0">
          ...
          foreach ($service_targets as $target):
            ...
            <div class="col<?= $this->agent->is_mobile() ? '-auto' : '' ?> text-center g-px-0">
              <a class="my_tab_2 g-cursor-pointer nav-link g-py-0 text-uppercase g-font-weight-700 g-font-size-<?= $this->agent->is_mobile() ? '14 g-px-30' : '18 g-px-20' ?> " data-tab="#tab-<?=$i?>" style="<?= $this->agent->is_mobile() ? 'min-height: 60px' : 'min-height: 50px' ?> ; color:#aaa">
                <i class="g-mr-10 g-mb-17 g-line-height-1 g-font-size-<?= $this->agent->is_mobile() ? '16' : '30' ?>"></i>
          ...
          <div class="bg-white g-my-20 box-shadow-down">
            <div class="g-pa-25">
              <div class="row">
                <?php if ($i%2==1){ ?>
                  <div class="col-6">
                    <img class="img-fluid w-100" src="<?=get_image(DIR_BG.$service->service_thumbnail,base_url('assets/img/error/1x2.png'))?>" alt="<?=$service->service_name.' image'?>" style="-webkit-mask-image: -webkit-gradient(linear, left top, right top, from(rgba(0,0,0,1)), to(rgba(0,0,0,0)));mask-image: linear-gradient(to left, rgba(0,0,0,1), rgba(0,0,0,0));">
                  </div>
                  <div class="col-6">
                  ...
                  <div class="col-6">
                    <img class="img-fluid w-100" src="<?=get_image(DIR_BG.$service->service_thumbnail,base_url('assets/img/error/1x2.png'))?>" alt="<?=$service->service_name.' image'?>" style="-webkit-mask-image: -webkit-gradient(linear, right top, left top, from(rgba(0,0,0,1)), to(rgba(0,0,0,0)));mask-image: linear-gradient(to right, rgba(0,0,0,1), rgba(0,0,0,0));">
                  </div>
                  <?php
                } //end if ($i%2==1)
                ?>
