					...
					if ($this->agent->is_mobile()) { //mobile view
						...
						<div class="bg-white g-my-20 box-shadow-down">
							...
							<div class="bg-white g-mx-20 g-pa-20" style=" margin-top: -40px;">
								...
								<a
									class="g-font-size-12 g-color-w4c-blue-v1 g-font-weight-700 mb-3 g-letter-spacing-1_5 text-uppercase <?= $service->has_page == 1 ? '' : 'd-none' ?>"
				...
				<div class="row no-gutters">
					...
					<div class="col-xs-12 col-md <?= $this->agent->is_mobile() ? 'text-center' : 'text-right' ?>">
						<a class="btn btn-info  g-brd-2 g-font-size-12 g-rounded-50 text-uppercase g-letter-spacing-2 g-px-20"
						   href="#"><?= lang('services_talk_to_expert') ?></a>
					</div>
				</div>
			</div>
		</div>
