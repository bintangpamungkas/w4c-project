    ...
    <div class="row">
      <div class="col-md-7 col-xs-12">
        ...
        <div class="row justify-content-center g-ma-0">
          <div class="col<?= $this->agent->is_mobile() ? '-auto' : '' ?> text-center g-px-0 tab-shadow">
            <a class="my_tab_2 g-cursor-pointer nav-link g-py-0 text-uppercase g-font-weight-700 g-font-size-<?= $this->agent->is_mobile() ? '14 g-px-30' : '18 g-px-30' ?> tab-active " data-tab="#tab-0" style="<?= $this->agent->is_mobile() ? 'min-height: 70px' : 'min-height: 50px' ?> ; color:#aaa">
          ...
          foreach ($service_targets as $target):
            ?>
            <div class="col<?= $this->agent->is_mobile() ? '-auto' : '' ?> text-center g-px-0">
              <a class="my_tab_2 g-cursor-pointer nav-link g-py-0 text-uppercase g-font-weight-700 g-font-size-<?= $this->agent->is_mobile() ? '14 g-px-30' : '18 g-px-20' ?> <?= $target['number']==1 ? '' : '' ?>" data-tab="#tab-<?= $target['number'] ?>" style="<?= $this->agent->is_mobile() ? 'min-height: 60px' : 'min-height: 50px' ?> ; color:#aaa">
                <i class="g-mr-10 g-mb-17 g-line-height-1 g-font-size-<?= $this->agent->is_mobile() ? '16' : '30' ?>"></i>
                <?= $target['title'] ?>
              </a>
            </div>
...
<div class="g-bg-secondary">
        ...
        <div class="bg-white g-my-20 box-shadow-down">
          <div class="g-pa-25">
            <div class="row">
              <?php if ($i%2==1){ ?>
                <div class="col-6">
                  <img class="img-fluid w-100" src="<?=base_url(DIR_BG.$service['4c_list_image'])?>" alt="<?=$service['4c_list_title'].' image'?>" style="-webkit-mask-image: -webkit-gradient(linear, left top, right top, from(rgba(0,0,0,1)), to(rgba(0,0,0,0)));mask-image: linear-gradient(to left, rgba(0,0,0,1), rgba(0,0,0,0));">
                </div>
                <div class="col-6">
                  <div class="mb-2">
                  ...
                  <div class="mb-5">
                    ...
                    <a class="g-font-color-w4c-blue-v1 g-font-weight-700 mb-3 text-uppercase" href="<?=$service['4c_list_url']?>"><?=lang('learn_more')?> <i class="fa fa-angle-right g-ml-10 g-font-size-20"></i> </a>
                ...
                <div class="col-6">
                  <img class="img-fluid w-100" src="<?=base_url(DIR_BG.$service['4c_list_image'])?>" alt="<?=$service['4c_list_title'].' image'?>" style="-webkit-mask-image: -webkit-gradient(linear, right top, left top, from(rgba(0,0,0,1)), to(rgba(0,0,0,0)));mask-image: linear-gradient(to right, rgba(0,0,0,1), rgba(0,0,0,0));">
                </div>
                <?php
              } //end if ($i%2==1)
              ?>
  ...
  <div class="g-bg-gray-light-v4 g-py-40">
    <div class="container">
      <div class="row">
        <div class="col-auto">
          <h3 class="g-font-weight-700"><?=lang('services_not_found')?></h3>
        </div>
