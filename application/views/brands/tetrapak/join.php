        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group g-mb-20 text-center" style="padding: 15px 8px">
                    ...
                    <iframe id="<?= $this->agent->is_mobile() ? 'gform' : '' ?>" style="height: <?= $this->agent->is_mobile() ? '1100px' : '1000px' ?>;width: 100%;border: none" src="https://docs.google.com/forms/d/e/1FAIpQLSfCBf_9Y7HAgVy_aMMGt7O4ZVllZWUJj3RJLCAMmCa3d0QV7Q/viewform?embedded=true">Memuat...</iframe>
                </div>
