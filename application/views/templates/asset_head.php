...
<main>
	...
	<div class="d-none"
		...
		<a target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLSfXpiHacFDeXi-ez3qmSOSN1Z4HDHOgAtu755kWHI2cowH3jg/viewform"
							...
							<div id="set_language" class="thisContent mb-4">
								...
								<div class="row justify-content-center">
									<div class="<?= $this->agent->is_mobile() ? 'col-10' : '' ?>">
										<div class="col-md-4">
											<div data-dismiss="<?= !$this->session->userdata('language') || $this->session->userdata('language') == 'id' ? '' : 'modal' ?>" data-url="<?= site_url('id') ?>"
												...
												<table class="table" style="margin: 0!important;">
													<tr>
														<td class="text-left"
														    style="padding: 0!important;border: none!important;"><?= !$this->session->userdata('language') || $this->session->userdata('language') == 'id' ? '<i class="fa fa-check-circle g-font-size-30"></i>' : '<i class="fa fa-circle-o g-font-size-30"></i>' ?> </td>
										...
										<div class="col-md-4">
											<div data-dismiss="<?= $this->session->userdata('language') == 'en' ? '' : 'modal' ?>" data-url="<?= site_url('en') ?>"
												...
												<table class="table" style="margin: 0!important;">
													<tr>
														<td class="text-left"
														    style="padding: 0!important;border: none!important;"><?= $this->session->userdata('language') == 'en' ? '<i class="fa fa-check-circle g-font-size-30"></i>' : '<i class="fa fa-circle-o g-font-size-30"></i>' ?> </td>
