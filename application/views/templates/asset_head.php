...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url(DIR_VENDOR . 'owl-carousel/owl.carousel.css') ?>"
    media="screen">
...
<body>
  ...
  <main>
    <div class="modal fade in" id="PopUpModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
      style="z-index: 9998">
      <div class="modal-dialog <?= $this->agent->is_mobile() ? 'g-ml-25 g-mr-25' : '' ?>" role="document"
        <?= $this->agent->is_mobile() ? '' : 'style="max-width:535px"' ?>>
        <div class="modal-content" style="border-radius: 0!important;margin-top: calc(50vh - 250px)">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"
            style="position: absolute;padding: 10px 15px;background: red;z-index: 999;opacity: 1;color: white;border-radius: 50px;right: -20px;top: -20px;"><span
              aria-hidden="true">&times;</span>
          </button>
          <div class="modal-body welcome_list g-pa-0">
            <a class="dismiss-modal" href="<?= site_url('service/personal-waste-management') ?>">
              <img src="<?php echo base_url(DIR_IMG . 'service/personal-waste-management/pwm.jpg') ?>"
                class="img-fluid">
            </a>
          </div>
        </div>
    ...
    <div class="modal fade in" id="PopUpModalPWM" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
      style="z-index: 9998">
      <div class="modal-dialog <?= $this->agent->is_mobile() ? 'g-ml-25 g-mr-25' : '' ?>" role="document"
        <?= $this->agent->is_mobile() ? '' : 'style="max-width:535px"' ?>>
        <div class="modal-content" style="border-radius: 0!important;margin-top: calc(50vh - 250px)">
    ...
    <div class="d-none"
      style="position: fixed;z-index: 999;bottom: <?= $this->agent->is_mobile() ? '25%' : '40%' ?>;right: <?= $this->agent->is_mobile() ? '-60px' : '-70px' ?>;-ms-transform: rotate(270deg);-webkit-transform: rotate(270deg);transform: rotate(270deg);">
      <a target="_blank"
        href="https://docs.google.com/forms/d/e/1FAIpQLSfXpiHacFDeXi-ez3qmSOSN1Z4HDHOgAtu755kWHI2cowH3jg/viewform"
        class="<?= $this->agent->is_mobile() ? 'g-font-size-12' : 'g-font-size-14' ?> btn g-brd-white-opacity-0_2 btn-danger g-color-white g-brd-2 g-pl-20 g-pr-15 g-py-9"
            ...
            <div class="mt-3">
                ...
                <div id="set_language" class="thisContent mb-4">
                  ...
                  <div class="row justify-content-center">
                    <div class="<?= $this->agent->is_mobile() ? 'col-10' : '' ?>">
                      <div class="col-md-4">
                        <div
                          data-dismiss="<?= !$this->session->userdata('language') || $this->session->userdata('language') == 'id' ? '' : 'modal' ?>"
                          data-url="<?= site_url('id') ?>"
                          class="<?= !$this->session->userdata('language') || $this->session->userdata('language') == 'id' ? 'g-bg-blue-opacity-0_7 g-color-white' : 'g-bg-blue--hover g-color-white--hover g-cursor-pointer block-link' ?> u-shadow-v1-5 g-color-black g-rounded-10 g-line-height-2 g-pa-20 g-mb-30 bg-white text-center"
                          role="alert">
                          <table class="table" style="margin: 0!important;">
                            <tr>
                              ...
                              <td class="text-left"
                                style="padding: 0!important;border: none!important;vertical-align: middle">INDONESIA
                              </td>
                            </tr>
                          </table>
                        </div>
                      ...
                      <div class="col-md-4">
                        <div data-dismiss="<?= $this->session->userdata('language') == 'en' ? '' : 'modal' ?>"
                          data-url="<?= site_url('en') ?>"
                          class="<?= $this->session->userdata('language') == 'en' ? 'g-bg-blue-opacity-0_7 g-color-white' : 'g-bg-blue--hover g-cursor-pointer block-link' ?> u-shadow-v1-5 g-color-black g-rounded-10 g-line-height-2 g-pa-20 g-mb-30 g-color-white--hover text-center"
                          role="alert">
                          <table class="table" style="margin: 0!important;">
                            <tr>
                              <td class="text-left" style="padding: 0!important;border: none!important;">
                              ...
                              <td class="text-left"
                                style="padding: 0!important;border: none!important;vertical-align: middle">ENGLISH</td>
                            </tr>
                          </table>
                        </div>
                      </div>
                ...
                <div id="services" class="thisContent">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 mb-4">
                      ...
                      <div
                        class="u-block-hover g-brd-around g-brd-gray-light-v4 rounded g-transition-0_3 g-px-20 g-py-20"
                      ...
                      <div class="pull-right" style="position: absolute;top: 70%;right: 40px;">
                        <a class="btn u-btn-<?= $nav['color'] ?> g-brd-2 g-font-size-13 g-rounded-50 g-pl-20 g-pr-15 g-py-9"
                          href="<?= $nav['url'] ?>">
              ...
              <div class="d-none <?= $this->agent->is_mobile() ? 'row justify-content-center' : '' ?>">
                <div class="<?= $this->agent->is_mobile() ? 'col-6' : 'text-center' ?>">
                  <a class="btn u-btn-primary g-brd-2 g-font-size-13 g-rounded-50 g-pl-20 g-pr-15 g-py-9 <?= $this->agent->is_mobile() ? 'btn-block mb-4' : '' ?>"
                    href="#how">
                    SUBMIT
                  </a>
                </div>
