<div class="shortcode-html" id="footer">
  <!-- Footer -->
  <footer class="g-color-white-opacity-0_8 g-bg-img-hero g-pt-60"
    style="background: radial-gradient(circle farthest-side at 70% -10%, rgba(21, 189, 119, 1), rgba(11, 141, 192, 1));">
    <div class="container g-mb-60">
      <div class="row">
          ...
          <ul class="list-unstyled">
            <li class="g-mb-5">
              <a class="g-color-white-opacity-0_8"
                href="<?= get_url('official/service') ?>"><?= get_lang('all-services') ?></a>
            </li>
            <li class="g-mb-5">
              <a class="g-color-white-opacity-0_8"
                href="<?= get_url('official/about') ?>"><?= get_lang('about-us') ?></a>
            </li>
            <li class="g-mb-5">
              <a class="g-color-white-opacity-0_8"
                href="<?= get_url('https://waste4change.com/blog') ?>"><?= get_lang('blog-and-news') ?></a>
            </li>
            <li class="g-mb-5">
              <a class="g-color-white-opacity-0_8"
                href="<?= get_url('official/contact') ?>"><?= get_lang('contact') ?></a>
            </li>
            <li class="g-mb-5">
              <a class="g-color-white-opacity-0_8"
        ...
        <div class="col-lg-auto col-md-6 g-mb-40 g-mb-0--lg <?= $this->agent->is_mobile() ? 'text-center' : '' ?>">
          <div id="accordion-<?= $i ?>" class="u-accordion u-accordion-bg-primary u-accordion-color-white"
            role="tablist" aria-multiselectable="true">
            <!-- Card -->
            <div class="g-brd-none rounded-0">
              <div id="accordion-<?= $i ?>-heading-02" class="g-pa-0" role="tab">
                <h5 class="mb-0">
                  <a class="collapsed g-color-white--hover g-text-underline--none--hover u-heading-v2__title h6 text-uppercase mb-0 font-weight-bold"
                    href="#accordion-<?= $i ?>-body-02" aria-expanded="false"
                    aria-controls="accordion-<?= $i ?>-body-02" data-toggle="collapse"
                    data-parent="#accordion-<?= $i ?>">
                    <?= $menu->title ?>
                    <span class="u-accordion__control-icon g-ml-10"> <i class="fa fa-angle-down"></i> <i
                        class="fa fa-angle-up"></i> </span>
                  </a>
                </h5>
              </div>
              <div id="accordion-<?= $i ?>-body-02" class="collapse" role="tabpanel"
                aria-labelledby="accordion-<?= $i ?>-heading-02" data-parent="#accordion-<?= $i ?>">
                <div class="u-accordion__body g-px-0">
                  <ul class="list-unstyled g-ma-0">
                    ...
                    <li class="g-mb-5">
                      <a class="g-color-white-opacity-0_8"
                        href="<?= get_url($subsubmenu->url) ?>"><?= $subsubmenu->title ?></a>
                    </li>
                    <?php endforeach; ?>
                    <?php endforeach; ?>
                    ...
                    <li class="g-mb-5">
                      <a class="g-color-white-opacity-0_8"
                        href="<?=get_url('http://w4c.id/rumahkompos')?>"><?=get_lang('home-composting')?></a>
                    </li>
                    <?php endif;?>
                  </ul>
                </div>
        ...
        <div class="col-lg col-md-6 g-mb-40 g-mb-0--lg <?= $this->agent->is_mobile() ? 'text-center' : '' ?>">
          ...
          <address class="mb-5 <?= $this->agent->is_mobile() ? 'text-center' : '' ?>">
            <div class="g-mb-10">
              ...
              <span><a class="g-color-white-opacity-0_8" target="_blank"
                  href="https://goo.gl/maps/h16wzCy2htA2"><?= OFFICIAL_ADDRESS ?></a></span>
            </div>
            ...
            <div class="g-mb-10">
              ...
              <span><a class="g-color-white-opacity-0_8"
                  href="mailto:<?= OFFICIAL_MAIL ?>"><?= OFFICIAL_MAIL ?></a></span>
            </div>
          </address>
          ...
          <ul class="list-inline mb-0">
            ...
            <li class="list-inline-item g-mr-10">
              <a class="u-icon-v3 u-icon-size--md g-bg-white-opacity-0_1 g-bg-white-opacity-0_2--hover g-color-white-opacity-0_6 g-rounded-50x"
                href="<?=$social['social_url']?>" target="_blank">
