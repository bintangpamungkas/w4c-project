				...
				<div class="col-lg col-md-6 g-mb-40 g-mb-0--lg <?= $this->agent->is_mobile() ? 'text-center' : '' ?>">
					...
					<ul class="list-inline mb-0">
						<li class="list-inline-item g-mr-10">
							<a class="u-icon-v3 u-icon-size--md g-bg-white-opacity-0_1 g-bg-white-opacity-0_2--hover g-color-white-opacity-0_6 g-rounded-50x" href="https://www.facebook.com/sharer/sharer.php?u=https://waste4change.com/" target="_blank">
