<?php
	...
	class Service_model extends CI_Model
	{
		...
		{
			$this->db->select(['service.service_id', 'service.service_category_id', 'service.service_parent_id', 'service.service_subcategory_name', 'service.service_short_name', 'service_client_name', 'service.service_slug', 'service.service_name', 'service.service_page_url', 'service.service_map_url', 'service.service_proposal_url', 'service.service_portfolio_url', 'service.service_about_image', 'service.service_header_image', 'service.service_thumbnail_image', 'service_category_name']);
