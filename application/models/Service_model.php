...
class Service_model extends CI_Model
{
  ...
  function get_service($lang,$service_slug){
    $this->db->select(['service.service_id','service.service_category_id','service_client_name','service.service_slug','service.service_name','service.service_page_url','service.service_join_url','service.service_proposal_url','service.service_portofolio_url','service.service_about_image','service.service_thumbnail','service_category_name']);
