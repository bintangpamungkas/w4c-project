  ...
  function navigation_menu_array_segment($user_target){
    ...
    $data['service_corporate']=[
      ...
      [
        ...
        'icon' => 'default.png',
        'image' => 'solid_waste_management_research.jpg',
        'recomendation' => ['General'],
    ...
    $data['service_brand']=[
      ...
      [
        'title' => 'Drop Box for Brand',
        'url' => W4C_URL.'service/dropbox-for-brand',
        'icon' => 'default.png',
        'is_new' => true,
        'category' => 'campaign',
        'number' => 2,
