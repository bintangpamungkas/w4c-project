  ...
  function render_page($content, $data = NULL, $template = NULL){
    ...
    foreach ($service_target as $target) {
      ...
      foreach ($service_category as $category) {
        $services=$this->crud_model->select('service',QUERY_RESULT,['service_id','service_slug url','service_name title','service_category_id','has_page'],['service_category_id'=>$category->service_category_id,'deleted_at'=>null,'service_parent_id'=>null]);
