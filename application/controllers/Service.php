...
//		$sections = $this->crud_model->select('service_section', QUERY_RESULT, '', ['service_section.service_id' => $service->service_id, 'service_section.deleted_at' => null]);
//		print_r($sections);
//		die();
		$data['title'] = '';
		$data['id'] = 'service';
		...
		$data['clients'] = $this->crud_model->select('client', QUERY_RESULT, '', ['service_id' => 1, 'deleted_at' => null]);
